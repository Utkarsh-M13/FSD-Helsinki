...
describe('total likes', () => {
  ...
  test('list has many many blogs', () => {
    let longBlogs = [];
    for (let i = 0; i < 100; i++) {
     longBlogs.push(...blogs) 
    }
    assert.strictEqual(listHelper.totalLikes(longBlogs), 3600)
  })
})
